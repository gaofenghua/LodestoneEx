...
namespace TransactionServerModules
{
    public class CgiFactory
    {
        ...
        public const string POST_DATA = "aa=111111111111111";
        ...
        public bool CURL_HTTP_Get(out string status, out string result)
        {
            ...
            easy.SetOpt(CURLoption.CURLOPT_USERPWD, m_args.UserName + ":" + m_args.Password);   // [user name]:[password]
            easy.SetOpt(CURLoption.CURLOPT_WRITEFUNCTION, wf);
            //easy.SetOpt(CURLoption.CURLOPT_WRITEDATA, m_args.Data); // not pass the whole m_args
        ...
        public Int32 OnWriteData(Byte[] buf, Int32 size, Int32 count, Object stream)
        {
            ...
            //CURL_HTTP_ARGS args = (CURL_HTTP_ARGS)stream;
            //if (null != stream)
            //{
            //    args.Data = System.Text.Encoding.Default.GetString(buf);
            //    args.DataLength += len;
            //}

            //m_args.Data += System.Text.Encoding.Default.GetString(buf);
